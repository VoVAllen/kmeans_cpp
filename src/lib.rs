...
extern "C" {
    fn kmeans_centroids_alloc(centroids: *const f32, k: c_longlong, dim: c_longlong) -> *mut c_void;
    fn kmeans_centroids_free(handle: *mut c_void);
    fn kmeans_centroids_ptr(handle: *mut c_void) -> *mut c_void;
    fn kmeans_assign(handle: *mut c_void,
                     data: *const f32,
                     n: c_longlong,
                     dim: c_longlong,
                     metric: c_int,
...
impl Centroids {
    ...
    pub fn assign(&self, data: &[f32], n: i64, dim: i64, metric: i32, out: &mut [i64]) {
